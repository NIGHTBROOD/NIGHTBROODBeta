...
function onTrigger(player,npc)
    ...
    elseif (player:getCurrentMission(TOAU) == IMPERIAL_SCHEMES and needToZone == false) then
    ...
    elseif (player:getCurrentMission(TOAU) == SENTINELS_HONOR and needToZone == false) then
