...
function onTrigger(player)
    if (player:getVar("GodMode") == 0) then
		...
		player:injectActionPacket( 6, 317 );
		player:injectActionPacket( 6, 316 );
		player:injectActionPacket( 6, 290 );
		player:injectActionPacket( 6, 281 );
		player:injectActionPacket( 6, 276 );
		player:injectActionPacket( 6, 260 );
		player:injectActionPacket( 6, 252 );
